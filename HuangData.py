...
def P3HTHuangDataLammps(Position_M, Position_S1, Position_S2, Filename):
    ...
    NumAtoms = Huang.NumChains*Huang.ChainLength*3
    NumBonds = Huang.NumChains*(Huang.ChainLength - 1 + Huang.ChainLength*2)
    NumAngles = Huang.NumChains*(Huang.ChainLength + 3*Huang.ChainLength - 4)
    NumDih = Huang.NumChains*(Huang.ChainLength - 3 + Huang.ChainLength - 1 + Huang.ChainLength - 1 + Huang.ChainLength - 1)
    #NumImproper = Huang.NumChains*(Huang.ChainLength - 2)
    NumImproper = 0
    ...
    File.write('\t1\t%.4f\t%.4f\n' %(Huang.P1P1[1], Huang.P1P1[0]))
    File.write('\t2\t%.4f\t%.4f\n' %(Huang.P1P2[1], Huang.P1P2[0]))
    File.write('\t3\t%.4f\t%.4f\n' %(Huang.P2P3[1], Huang.P2P3[0]))
    ...
    File.write('\t1\t%.4f\t%.4f\t%.4f\t%.4f\t%.4f\n' % (Huang.P1P1P1P1[0], Huang.P1P1P1P1[1], Huang.P1P1P1P1[2], Huang.P1P1P1P1[3], Huang.P1P1P1P1[4]))
    File.write('\t2\t%.4f\t%.4f\t%.4f\t%.4f\t%.4f\n' % (Huang.P2P1P1P2OPT[0], Huang.P2P1P1P2OPT[1], Huang.P2P1P1P2OPT[2], Huang.P2P1P1P2OPT[3], Huang.P2P1P1P2OPT[4]))
    File.write('\t3\t%.4f\t%.4f\t%.4f\t%.4f\t%.4f\n' % (Huang.P1P1P2P3[0], Huang.P1P1P2P3[1], Huang.P1P1P2P3[2], Huang.P1P1P2P3[3], Huang.P1P1P2P3[4]))
    File.write('\t4\t%.4f\t%.4f\t%.4f\t%.4f\t%.4f\n\n' % (Huang.P3P2P1P1[0], Huang.P3P2P1P1[1], Huang.P3P2P1P1[2], Huang.P3P2P1P1[3], Huang.P3P2P1P1[4]))
    ...
    Mol_id = 0
    k = 0
    for i in range(Huang.NumChains):
        Mol_id += 1
        for j in range(Huang.ChainLength):
            Atom_id += 1
    ...
    B =1 
    for i in range(Huang.NumChains):
        for j in range(Huang.ChainLength - 1):
            E+= 1
            File.write('%d 1 %d %d\n' % (E, B, B+3))
            E += 1
            File.write('%d 2 %d %d\n' % (E, B, B+1))
    ...
    B = 1
    for i in range(Huang.NumChains):
        for j in range(Huang.ChainLength - 2):
            E += 1
    ...
    B = 1
    for i in range(Huang.NumChains):
        for j in range(Huang.ChainLength - 3):
            E += 1 
...
def Calculate_LP( In_FILE, Restart_In, Restart_out, Num_Steps=10000, Time_Step = 1, Temp= 300, Press = 1):
    ...
    Corr, CorrT, CorrCh = Persistence_Length( Positions, N, T, 3,Huang.ChainLength)
